...
class MoveWheelTrajectory():
    ...
    # def callback_jointState(self, msg, k_pos=1.0, k_vel=1, k_acc=0.05):
        # TODO test noise to get a elaborate kalman filter
        with self.mutex:
            ...
            # Simplified kalman filter. Adapt?
            ...
            # print('dt', dt)
            # print('joint pos raw', joint_pos_new)
            # print('joint pos', self.joint_pos)
            # print('joint ven raw', joint_vel_new)
            # print('joint vel', self.joint_vel)
            # print('joint acc', self.joint_acc)
